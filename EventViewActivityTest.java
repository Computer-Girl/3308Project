...
public class EventViewActivityTest {
     ...
     * @version 1
     * @author jasmine
     * checks for basic user interface, text views, buttons, toolbar
     * and checks their functionality i.e do they work
     */
    @Test
...
//checks for UI, such as text views, the buttons toolbar for the user. .
     ...
     * @version 1
     * @author Jasmine
     * tests to see if next activity opens up correctly and
     * has correct functionality i.e does it do what the group
     * intended it to do
     */
